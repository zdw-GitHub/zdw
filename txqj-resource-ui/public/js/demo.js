...
//        this._createDemoNode('Attachment Demo', topologyNode, 'network/AttachmentDemo');
    ...
    createNetworkToolbar: function (network, interaction) {
        ...
        demo.Util.addButton(toolbar, '默认', 'select', function () {
        ...
        demo.Util.addButton(toolbar, '放大镜', 'Magnify', function () {
            network.setMagnifyInteractions();
        });
//        demo.Util.addButton(toolbar, 'Pan', 'pan', function () { network.setPanInteractions(); });
        demo.Util.addButton(toolbar, '放大', 'zoomIn', function () { network.zoomIn(); });
        demo.Util.addButton(toolbar, '缩小', 'zoomOut', function () { network.zoomOut(); });
        demo.Util.addButton(toolbar, '缩放复位', 'zoomReset', function () { network.zoomReset(); });
        demo.Util.addButton(toolbar, '自适应屏幕', 'zoomOverview', function () { network.zoomOverview(); });
