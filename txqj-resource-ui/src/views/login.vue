<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="code" v-if="captchaEnabled" style="margin-bottom: 30px !important;">
        <el-input
      ...
      <el-form-item style="width:100%; margin-bottom: 30px !important;">
        <el-button
          :loading="loading"
          size="medium"
          type="primary"
