<template>
  <div class="app-container">
    ...
    <!--表单配置详情-->
    <el-dialog
      v-dialogDrag :title="formTitle" :visible.sync="formConfOpen" width="60%" append-to-body :close-on-click-modal="false">
      <div class="test-form">
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.$router.push({ path: '/tool-build/index', query: {formId: id }})
    },
    /** 提交按钮 */
    submitForm() {
