<template>
    <div class="ywysj">
          ...
          <div class="r_bot" v-if="tabName==='Tab1'">
            <div class="tit cell">
              <div class="cell" style="float: right;width: 120%;text-align: right;margin-bottom: 10px;">
                ...
                <!-- <el-button  plain style="padding:5px 15px;width:80px" :disabled="ifSel" type="primary" @click="importTableClu()" icon="el-icon-plus">导入</el-button> -->
              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    ...
                    <!-- <el-select   filterable v-model="scope.row.ruleId"  @change="$forceUpdate()" v-show="scope.$index == cellIndex" placeholder="请选择" style="width:130px">
                      <el-option
                      :label="DescriptionList.ruleDescription"
                      :value="DescriptionList.id"
                      :key="DescriptionList.id"
                      ></el-option>
                    </el-select> -->
                    <el-tooltip class="item" effect="light" placement="top"  v-show="scope.$index == cellIndex">
                      <div v-html="DescriptionList.ruleDescription" slot="content" style="max-width:300px"></div>
                      <div class="oneLine">{{DescriptionList.ruleDescription}}</div>
                    </el-tooltip>
                ...
                <el-table-column
                  ...
                  <el-col :span="6">
                    <el-button circle plain  v-show="scope.$index == cellIndex" style="width:30px ;height:30px ;padding:5px 5px " class="el-icon-edit-outline" @click="editLevel(scope)" :type="savelevelForm.ifSave"  autofocus></el-button></el-col>
                  </el-row>
                    </template>
                </el-table-column>
                <!-- <el-table-column
                  ...
                  width="140">
                  <template slot-scope="scope">
                    <el-select filterable   v-model="scope.row.ruleId" v-show="scope.$index == cellIndex" @change="getDesciption(scope.row.ruleId)" placeholder="请选择" style="width:130px">
                      <el-option v-for="item in rulesList"
                      :label="item.ruleName"
                      :value="item.id"
                      :key="item.id"></el-option>
            ...
            <div >
              <el-table
                ...
                <el-table-column
                  ...
                  >
                  <template slot-scope="scope">
                    <!-- scope.$index为当前行下标，cellIndex1所点击行下标 -->
                    <!-- <el-select   filterable v-model="scope.row.ruleId"  @change="$forceUpdate()" v-show="scope.$index == cellIndex1" placeholder="请选择" style="width:130px">
                      <el-option
                      :label="DescriptionList.ruleDescription"
                      :value="DescriptionList.id"
                      :key="DescriptionList.id"
                    ...
                    <el-tooltip class="item" effect="light" placement="top"  v-show="scope.$index == cellIndex1">
                      <div v-html="DescriptionList1.ruleDescription" slot="content" style="max-width:300px"></div>
                      <div class="oneLine">{{DescriptionList1.ruleDescription}}</div>
                    </el-tooltip>
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <!-- scope.$index为当前行下标，cellIndex1所点击行下标 -->
                    <!-- <el-input
                        v-model="scope.row.useDefinedVerSql"
                        style="width:330px;"
                        v-show="scope.$index == cellIndex1"
                        :disabled="ifSql">
                    </el-input> -->
                    <el-button circle plain  style="width:35px ;height:35px ;" v-show="scope.$index == cellIndex1" class="el-icon-edit-outline" @click="editSql(scope)" :type="saveRelationForm.ifSave"  autofocus></el-button>
                    <el-tooltip v-show="scope.$index != cellIndex1" class="item" effect="light" placement="top">
      ...
      <el-dialog
          ...
          :visible.sync="addNewRulesDrawer"
          style="margin-top: 17vh !important;"
        >
          <el-form label-width="80px" style="text-align: center" >
            <el-form-item label="选择表属性"  >
              <el-select v-model="newRulesId">
                <el-option  v-for="item in tableData"
                :label="item.columnNameCn"
                :key="item.metaModelColumnId"
                :value="item.metaModelColumnId"></el-option>
              </el-select>
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer">
            <el-button  type="primary" @click="nextNewRulesDrawer = true" >下一步</el-button>
            <el-button @click="addNewRulesDrawer = false">取 消</el-button>
          </div>
        </el-dialog>
        <el-dialog
          title="新增属性标准"
          ...
          <el-form label-width="80px" style="text-align: center" >
            ...
            <el-form-item label="规则描述"  >
              <el-tooltip class="item" effect="light" placement="top" >
                      <div v-html="DescriptionList.ruleDescription" slot="content" style="max-width:200px"></div>
                      <div class="oneLine">{{DescriptionList.ruleDescription}}</div>
              </el-tooltip>
            </el-form-item>
            ...
            <el-form-item label="比较内容类别"  >
              <el-select filterable   v-model="addRulesForm.selectType" placeholder="请选择" style="width:200px;margin-left:0px" @change="$forceUpdate()">
                    <el-option v-for="item in saveConditions"
                      :label="item.query_name"
                      :value="item.id"
                      :key="item.id">
                    ...
                    <el-button circle plain  style="width:30px ;height:30px ;padding:5px 5px;position:absolute;right:10px;top:5px" class="el-icon-edit-outline" @click="editLevel1(addRulesForm)" :type="savelevelForm.ifSave"  autofocus></el-button>
            </el-form-item>
            <el-form-item label="告警级别"  >
              <el-select filterable  v-model="addRulesForm.alarmLevel" placeholder="请选择" style="width:200px" @change="$forceUpdate()">
                      <el-option v-for="item in alarmList"
                      :label="item.dictLabel"
                      :value="item.dictValue"
                      :key="item.dictValue"></el-option>
        ...
        >
          <el-form label-width="80px" style="text-align: center" >
            <el-form-item label="SQL" prop="sql" >
              <el-input v-model="levelForm.customizedSql" type="textarea" ></el-input>
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer">
        ...
        >
          <el-form :model="uploadTableForm" :rules="rules" ref="uploadTableForm" label-width="80px" style="text-align: center">
            <el-form-item label="填报" >
              <el-input type="textarea"  placeholder="多个参数请用逗号隔开" v-model="levelForm.relParam"></el-input>
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer">
        ...
        <el-form>
              <div >
                <el-form-item style="flex: 6" label="关联元模型">
                  <el-select v-model="levelForm.relMetaModeId" @change="getTableClu(levelForm.relMetaModeId)" filterableplaceholder="请选择" style="width:200px">
              ...
              <div style="display: flex;width: 70%">
                <el-form-item style="flex: 6" label="关联属性" prop="columnName">
                 <el-select  placeholder="请选择"  v-model="levelForm.relIdMetaModelColumnId" @change="$forceUpdate()" style="width:200px">
                  ...
                  <!-- <el-input disabled v-model="metaIdList.metaName"></el-input> -->
                </el-form-item>
                <el-form-item style="flex: 6" label="关联表别名" prop="columnName">
                 <el-select  disabled placeholder="单击表格进行选择"  v-model="levelForm.relNameMetaModelColumnId" @change="changeUp()" style="width:200px">
                    <el-option
                    :label="metaIdList.metaName"
                    :key="metaIdList.id"
                    :value="metaIdList.id">
                  </el-option>
                  </el-select>
              ...
              <el-table
                ...
                <!-- <el-form-item label="关联条件"  style="margin-top:20px">
                  <el-input  type="textarea" v-model="levelForm.relParam"></el-input>
                </el-form-item> -->
...
export default {
  ...
  methods: {
    ...
    addTableClu() {
      var tMetaModelTech = {
          ...
          request({
            ...
            // 请求成功处理。
            this.getRulesData()
            this.cellIndex1 = this.rulestableData.length
    ...
    getRulesData () {
      this.rulestableData = []
      request.get('/verification/list?metaModeId=' + this.modelId  + '&modelVersion=' + this.modelVersion
    ...
    getmetaData(id) {
      if(id!==undefined){
      request.get('/tech/list?modelId=' + id + '&columnName=' + this.searchmetaName, qs.stringify({
      })).then((res) => {
        // 请求成功处理。
        this.metatableData = res.rows
      }).catch(e => {
        // 请求失败处理。
        this.$message({
          message: e,
    ...
    getmodelIdList() {
      ...
      request.get('/model/list?isDelete=' + '0', qs.stringify({
      })).then((res) => {
        // 请求成功处理。
        console.log(res.rows)
        this.modelIdList = res.rows
      }).catch(e => {
        // 请求失败处理。
        this.$message({
          message: e,
    ...
    // 取消
    cancelLevelBox() {
      /* this.levelForm = this.savelevelForm */
    ...
    saveRelMeta() {
      ...
      /* this.savelevelForm.relParam = this.levelForm.relParam */
      this.writeDrawer = false
    },
    //获取规则名称
    getruleNameList() {
    ...
    editTable ({ $index }) {
      ...
      /* for(var i=0;i<this.rulesList.length;i++) {
        if(this.tableData[]===this.rulesList[i].id) {
          this.DescriptionList.ruleDescription = this.rulesList[i].ruleDescription
          this.getSign(this.rulesList[i].englishName)
        } */
      this.savelevelForm = {}
      this.DescriptionList.ruleDescription=this.tableData[$index].ruleDescription
     ...
     editTable1 ({ $index }) {
      ...
      this.DescriptionList1.ruleDescription=this.tableData[$index].ruleDescription
    ...
    saveTable ({ row }) {
      ...
      /* console.log(this.savelevelForm.relIdMetaModelColumnId) */
      request({
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    saveTable1({row}) {
      var params = {
        ...
        metaModeId: this.modelId,
        modelVersion: this.modelVersion,
        ruleDescription: this.DescriptionList1.ruleDescription,
        modificationSuggestions: row.modificationSuggestions,
    ...
    editLevel1: function (row) {
      ...
      if (row.selectType === '0'){
          ...
          if(this.savelevelForm.param === '' || this.savelevelForm.param === undefined) {
            ...
            this.levelForm.param = this.savelevelForm.param
          }
          ...
          if(this.savelevelForm.relMetaModeId !== '' || this.savelevelForm.relMetaModeId !==undefined) {
            ...
            if(this.savelevelForm.relIdMetaModelColumnId !==''|| this.savelevelForm.relIdMetaModelColumnId!==undefined) {
            ...
            this.levelForm.relIdMetaModelColumnId = row.metaModelColumnId
          }
          } else {
            /* this.metatableData = [] */
            this.levelForm.relMeta
            this.levelForm.relMetaModeId = row.MetaModeId
          }

          /* if(this.savelevelForm.relParam !=='' || this.saveLevelForm.relParam !==undefined) {
            this.levelForm.relParam = this.savelevelForm.relParam
          } else {
            this.levelForm.relParam = row.relParam
          } */
    ...
    editLevel: function ({row}) {
      ...
      if (row.selectType === '0'){
          ...
          if(this.savelevelForm.relMetaModeId === '' || this.savelevelForm.relMetaModeId ===undefined) {
            this.getTableClu(row.metaModeId)
    ...
    getData: function () {
      ...
      this.tableData = []
      request.get('/verrules/attrList?modelId=' + this.modelId + '&modelVersion=' + this.modelVersion +
      '&columnName=' + this.selForm.cluName + '&pageNum=' + this.pageIndex + '&pageSize=' + this.pageSize, qs.stringify({
      })).then((res) => {
        // 请求成功处理。
        /* console.log(res) */
