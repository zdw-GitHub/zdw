              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-button circle plain  style="width:35px ;height:35px ;" v-show="scope.$index == cellIndex1" :disabled="ifSql" class="el-icon-edit-outline" @click="editSql(scope)" :type="saveRelationForm.ifSave"  autofocus></el-button>
                    <el-tooltip v-show="scope.$index != cellIndex1" class="item" effect="light" placement="top">
          ...
          <el-form label-width="80px" style="text-align: center" >
            ...
            <el-form-item label="比较内容类别"  >
              <el-select filterable   v-model="addRulesForm.selectType" placeholder="请选择" style="width:200px;margin-left:0px" @change="$forceUpdate()" clearable>
                    ...
                    <el-button circle plain  style="width:30px ;height:30px ;padding:5px 5px;position:absolute;right:-25px;top:4px" class="el-icon-edit-outline" @click="editLevel1(addRulesForm)" :type="savelevelForm.ifSave"  autofocus></el-button>
            </el-form-item>
            <el-form-item label="告警级别"  >
