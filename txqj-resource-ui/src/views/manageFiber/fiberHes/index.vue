<template>
  <div>
    <zdzywhPage
      ...
      :tableName="tableName"
      :rightClickMenus="[
        { name: '相关光缆', icon: 'el-icon-upload2',functionName: 'relatedOpticalCables'},
        { name: '光缆示意图', icon: 'el-icon-paperclip',functionName: 'opticalCableSchematicDiagram'},
        { name: '重新生成光缆示意图', icon: 'el-icon-paperclip',functionName: 'generateChart'},
      ]"
      @relatedOpticalCables="relatedOpticalCables"
      @opticalCableSchematicDiagram="opticalCableSchematicDiagram"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="saveTemporary">保  存</el-button>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      opticalCableSchematicDiagram(data){
        this.taskId = data.rowData.TASK_ID
